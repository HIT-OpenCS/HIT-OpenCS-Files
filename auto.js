...
let basepath = "./"; //解析目录路径
let filterFile = [".git", "auto.js", "README.md", "_sidebar.md","_coverpage.md", "index.html", ".nojekyll", "autosidebar.js", "_sidebar.md.bak"]; //过滤文件名，使用，隔开
...
function consoleTree(tree, str = "", adder = "") {
    ...
    list.forEach(ele => {
        ...
        if (ele.children) {
            ...
            fileTree += str + "[" + ele.fname + "]" + "(" + "https://raw.gitmirror.com/HIT-OpenCS/HIT-OpenCS-Files/main/" + ele.name + ")" + "\n\n";
        }
    });
}
